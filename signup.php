...
<body>
    <form action="signup_post.php" method="post">
        ...
        <div class="job">
            ...
            <select name="job" title="job" id="job">
        ...
        <div class="birthday">
            ...
            <?php
                if(isset($birthday_err)){
                    echo "<h5>$birthday_err</h5>";
                }
            ?>

            <div class="birthSelect">
                <select aria-label="Month" name="birthday_month" id="month" title="Month" class="_9407 _5dba _9hk6 _8esg"><option value="1">Jan</option><option value="2">Feb</option><option value="3" selected="1">Mar</option><option value="4">Apr</option><option value="5">May</option><option value="6">Jun</option><option value="7">Jul</option><option value="8">Aug</option><option value="9">Sep</option><option value="10">Oct</option><option value="11">Nov</option><option value="12">Dec</option></select>
        ...
        <input type="submit" value="signup" id="register" name="submit">

        <p>you already member? <a href="./login.php">logIn</a></p>
    </form>
</body>
</html>