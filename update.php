...
<body>
  <form action="update-update.php" method="post">
    ...
    <input type="text" value="<?php echo "$username"; ?>" placeholder="username" id="username" name="username">
    ...
    <input type="email" value="<?php echo "$email"; ?>" placeholder="email" id="email" name="email">
    ...
    <input type="submit" value="Update" id="register" name="submit">
